...
export const initialChatSessions: ChatSession[] = [
  {
    id: "chat-active",
    incidentId: "INC-PCF-240724-001",
    title: "Synthetic PCF blocked",
    fundId: "LU0411078552",
    updatedAt: "2026-07-24T09:34:00.000Z",
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        createdAt: "2026-07-23T15:41:30.000Z",
      },
    ],
  },
  {
    id: "chat-load",
    incidentId: "INC-DATA-240722-008",
    ...
    messages: [
      ...
      },
      {
        ...
        createdAt: "2026-07-22T10:51:10.000Z",
      },
    ],
  },
  {
    id: "chat-prev-pcf",
    incidentId: "INC-PCF-240721-003",
    ...
    messages: [
      ...
      },
      {
        ...
        createdAt: "2026-07-21T09:41:30.000Z",
      },
    ],
  },
];
